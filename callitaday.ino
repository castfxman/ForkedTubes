...
#define PIXEL_PIN_2  7  // Digital IO pin connected to the NeoPixels.

#define PIXEL_COUNT_TALL 241 // Number of NeoPixels
#define PIXEL_COUNT_SHORT 150 // CHANGE

Adafruit_NeoPixel strip(PIXEL_COUNT_TALL, PIXEL_PIN, NEO_GRBW + NEO_KHZ800);// This declares the name of the led strip
Adafruit_NeoPixel strip2(PIXEL_COUNT_SHORT, PIXEL_PIN_2, NEO_GRBW + NEO_KHZ800) ; 
...
void loop() {
  ...
  strip.setBrightness(145);
  strip2.setBrightness(145);
  uint8_t padnumber = 1;
  uint8_t padnumber2 = 11;
...
if ((currtouched2 & _BV2(padnumber2))  &&  !(lasttouched2 & _BV2(padnumber2)) )
{
  Serial.println("SECOND BUTTON TOUCHED");
}
